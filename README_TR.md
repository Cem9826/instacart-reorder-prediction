...
**[İnteraktif dashboard](https://lookerstudio.google.com/reporting/3f7bae42-97c9-4cb5-81b7-f99742854fcd)** · 4 sayfa: genel bakış, davranış, model, etki
...
Kaggle'daki [Instacart Market Basket Analysis](https://www.kaggle.com/datasets/psparks/instacart-market-basket-analysis) veri seti. Altı tablo, 3,4 milyon sipariş, 32,4 milyon ürün satırı.

Ham CSV'ler bu repoda yok — yukarıdaki bağlantıdan indirip BigQuery'ye yüklemek gerekiyor. `outputs/tables/` klasöründe bu projenin ürettiği özet CSV'ler var, dashboard onları okuyor.
