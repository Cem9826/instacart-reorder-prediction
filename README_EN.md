...
Instacart Online Grocery Basket Analysis dataset. Six tables, 3.4 million orders, 32.4 million product lines.
...
Raw data: [Instacart Online Grocery Basket Analysis]([https://www.kaggle.com/c/instacart-market-basket-analysis/data](https://www.kaggle.com/datasets/psparks/instacart-market-basket-analysis)) — download from Kaggle and load into BigQuery.

The `outputs/tables/` folder contains the summary CSVs generated by this project, which feed the dashboard.
